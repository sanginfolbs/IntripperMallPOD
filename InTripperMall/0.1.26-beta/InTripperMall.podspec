...
#s.license      = "Copyright"
s.license      = { :type => "Copyright", :file => "FILE_LICENSE", :text=> " Copyright © 2018 Sanginfo. All rights reserved." }
  ...
  s.source       = { :git => "https://github.com/sanginfolbs/IntripperMallSDK.git", :tag => "0.1.26-beta" }
