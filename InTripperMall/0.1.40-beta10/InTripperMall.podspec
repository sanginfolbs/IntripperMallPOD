...
Pod::Spec.new do |s|
  ...
  s.name         = "InTripperMall"
  s.version      = "0.1.40-beta10"
...
#s.license      = "Copyright"
s.license      = { :type => "Copyright", :file => "FILE_LICENSE", :text=> " Copyright © 2018 Intripper. All rights reserved." }
  ...
  s.source       = { :git => "https://github.com/sanginfolbs/IntripperMallSDK.git", :tag => "0.1.40-beta10" }
